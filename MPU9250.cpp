...
bool MPU9250::initialize(int sample_rate_div, int low_pass_filter)
{
    ...
    uint8_t MPU_Init_Data[MPU_InitRegNum][2] = {
        ...
        {0x02, MPUREG_CONFIG},         // Use DLPF set Gyroscope bandwidth 184Hz, temperature bandwidth 188Hz
        {0x18, MPUREG_GYRO_CONFIG},    // +-2000dps
        {0x08, MPUREG_ACCEL_CONFIG},   // +-4G
        {0x03, MPUREG_ACCEL_CONFIG_2}, // Set Acc Data Rates, Enable Acc LPF , Bandwidth 184Hz
