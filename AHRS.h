...
public:
	...
	:	 q0(q0), q1(q1), q2(q2), q3(q3), twoKi(0.001), twoKp(1.5)  {;}
	...
	void updateIMU(float ax, float ay, float az, float gx, float gy, float gz, float dt)
	{
		...
		float qa, qb, qc;
                ...
                /*
                std::cout << "raw : " << gx << " " << gy << " ";
                std::cout << gz << " " << ax << " "<< ay <<" " << az << std::endl;
                        
                std::cout << "offset : " << gyroOffset[0] << " ";
                std::cout << gyroOffset[1] << " " << gyroOffset[2];
                std::cout << " " << accelOffset[0] << " " << accelOffset[1];
                std::cout << " " << accelOffset[2] <<std::endl;;
		*/
		...
		az -= accelOffset[2];
                ...
                //std::cout << "scaled : "<< gx<<" "<<gy<<" " <<gz<<" "<<ax<<" "<<ay<<" "<<az<<std::endl;
	...
	void setGyroOffset(float offsetX, float offsetY, float offsetZ)
	{
        ...
        void setAccelOffset(float offsetX, float offsetY, float offsetZ)
	{
